...
# File: design3.tcl
# Generated on: Wed Aug 18 11:31:42 2010
...
if {[is_project_open]} {
	if {[string compare $quartus(project) "design3"]} {
		puts "Project design3 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists design3]} {
		project_open -revision design3 design3
	} else {
		project_new -revision design3 design3
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name VHDL_FILE ../demo/seven_segment_decoder.vhd
	set_global_assignment -name BDF_FILE design3.bdf
