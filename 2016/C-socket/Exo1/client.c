...
int main(int argc, char** argv) {
    ...
    int recv_msg = recvfrom(mysock, server_msg, 50, 0, (struct sockaddr*)&server_address, (socklen_t*)&taille);
    if(recv_msg==-1) perror("recvfrom");
    int recv_msg2 = recvfrom(mysock, server_msg2, 50, 0, (struct sockaddr*)&server_address, (socklen_t*)&taille);
    if(recv_msg2==-1) perror("recvfrom");
