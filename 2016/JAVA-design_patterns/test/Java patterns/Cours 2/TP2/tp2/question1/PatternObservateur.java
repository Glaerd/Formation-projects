...
/**/     list1.insert( " un " );
    ...
    // verifier que les deux observateurs ont bien ete notifies avec les bons paramètres
           ...
           assertFalse(o1.senders().empty()); // Sender vide ?
           assertFalse(o2.senders().empty());
           assertEquals(list1, o1.senders().pop()); //   Vérifier si bon émetteur
  ...
  public void test3()
  {
    ...
    list1.deleteObserver(o2);
    assertEquals(1,list1.countObservers());
    list1.deleteObserver(o1);
    assertEquals(0,list1.countObservers());
