...
*/
  ...
  private Instruction ast= new Sequence(new Affectation(xxx,n),
                                        new Sequence(new Affectation(fact,un),
                                        new TantQue(new Non(new Egal(xxx,zero)),
                                        new Sequence(new Affectation(fact,new Multiplication(fact,xxx)),
