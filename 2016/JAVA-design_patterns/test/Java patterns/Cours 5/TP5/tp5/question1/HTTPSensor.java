...
//  public final static String DEFAULT_HTTP_SENSOR= "http://lmi92.cnam.fr:8999/ds2438/";
  public final static String DEFAULT_HTTP_SENSOR= "http://163.173.228.92/ds2438/ds2438/";
  ...
  {
    StringTokenizer Stringres = new StringTokenizer(this.request(),"=");
    Stringres.nextToken();
    float res = Float.parseFloat(Stringres.nextToken())*10;
    int resInt = (int) res;
    return (float) resInt/10; // point de rosee
  } // value()
