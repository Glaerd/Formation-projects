...
public class AppletteTestEnsemble extends JApplet
{
    ...
    public void init()
    {
        ...
        // Netscape & Internet Explorer) qui interdisent l'accès a la queue 
    ...
    { //GEN-BEGIN:initComponents
        ...
        button1.addActionListener ( 
            new ActionListener() {
                ...
                // a remplacer, par une instance de classe anonyme, usage de unionActionPerformed voir en bas de page
        );
    ...
    private Ensemble<String> getSet( final JTextField saisie )
    {
